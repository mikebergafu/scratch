              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="responsive_table.php">Table Views</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> DataBree Table Center</h3>
		  	
		  	
		  	<div class="row mt">
              <div class="col-lg-12">
                      <div class="content-panel">
						  <h4><i class="fa fa-angle-right"></i> Signages Captured Table</h4>
                          <?php 
							require_once (__DIR__ .'../../server/mysqli-engine.php');
							// Our database object
							$db=new MySqliDb();
                          ...
                          <section id="no-more-tables">
                              <table class="table table-bordered table-striped table-condensed cf">
                                  ...
                                  <tr>
                                      ...
                                      <th class="numeric">Faces</th>
                                      <th class="numeric">C-Type</th>
                                      <th class="numeric">S-Type</th>
